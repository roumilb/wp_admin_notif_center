...
You can download the package on wordpress.org and install it on your website or directly install it via the plugin installer on your backend.

== Screenshots ==

1. Screenshots of the pages "plugins installed" without the plugin
2. Screenshots of the pages "plugins installed" with the plugin
2. Screenshots of the plugin settings

== Changelog ==

= 1.5 =
* Fixed some notification counted but not displayed
